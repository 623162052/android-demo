package cs.plugins.map.amap.location;
	...
	Handler mHandler = new Handler() {
		public void dispatchMessage(Message msg) {
			...
			case Utils.MSG_LOCATION_FINISH:
				...
				// TODO: 记录定位改变信息到内存
				String locationStr = loc.getLongitude() + "-" + loc.getLatitude();
				SharedPreferencesUtil spUtil = SharedPreferencesUtil.getInstance(BaseApplication.getContext());
				String originalLocation = spUtil.getString("location");
				spUtil.putString("location", originalLocation.equals("") ? locationStr : originalLocation + ":" + locationStr);
